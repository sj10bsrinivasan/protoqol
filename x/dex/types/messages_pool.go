...
func NewMsgCreatePool(creator string, amount sdk.Coin, height int32) *MsgCreatePool {
...
func NewMsgUpdatePool(creator string, id uint64, amount sdk.Coin, height int32) *MsgUpdatePool {
